...
var NgReduxRouter = (function () {
    ...
    NgReduxRouter.prototype.getDefaultUrlStateObservable = function () {
        var _this = this;
        return this.router.events.pipe(filter_1.filter(function (event) { return event instanceof router_1.NavigationEnd; }), map_1.map(function (event) { return _this.location.path(); }), distinctUntilChanged_1.distinctUntilChanged());
    };
    ...
    NgReduxRouter.prototype.listenToReduxChanges = function () {
        ...
        this.reduxSubscription = this.ngRedux
            ...
            .pipe(distinctUntilChanged_1.distinctUntilChanged())
