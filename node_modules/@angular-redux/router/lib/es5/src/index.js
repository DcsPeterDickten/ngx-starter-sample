...
var NgReduxRouterModule = (function () {
    ...
    NgReduxRouterModule_1 = NgReduxRouterModule;
    NgReduxRouterModule.forRoot = function () {
        return {
            ngModule: NgReduxRouterModule_1,
            providers: [router_1.NgReduxRouter]
        };
    };
    NgReduxRouterModule = NgReduxRouterModule_1 = __decorate([
        core_1.NgModule()
    ], NgReduxRouterModule);
    return NgReduxRouterModule;
    var NgReduxRouterModule_1;
}());
