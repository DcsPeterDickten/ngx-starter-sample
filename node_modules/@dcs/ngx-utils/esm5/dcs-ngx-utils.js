...
function createReduxStore(rootReducer, initialState, middleware, enhancers) {
    if (initialState === void 0) { initialState = fromJS({}); }
    if (middleware === void 0) { middleware = []; }
    if (enhancers === void 0) { enhancers = []; }
    return /** @type {?} */ (createStore(rootReducer, initialState, compose.apply(void 0, tslib_1.__spread([applyMiddleware.apply(void 0, tslib_1.__spread(middleware))], enhancers))));
}
/**
 ...
 * @param action
 */
var observableMiddleware = function (store) { return function (next) { return function (action) {
    if (action.payload instanceof Observable) {
        ...
        obs.subscribe(function (data) { return store.dispatch({
            type: baseType_1 + "_NEXT",
            payload: data,
            meta: action.meta,
        }); }, function (error) { return store.dispatch({
            type: baseType_1 + "_ERROR",
            payload: error,
            meta: action.meta,
        }); }, function () {
            if (action.meta && action.meta["dispatchCompleted"]) {
                store.dispatch({ type: baseType_1 + "_COMPLETED" });
            }
        });
    }
    else {
...
var MainBaseModule = /** @class */ (function () {
     ...
     * @param {?} stableService
     */
    function MainBaseModule(store, devTools, rootReducer, rootEpic, ngReduxRouter, environment, stableService) {
        this.store = store;
    ...
    MainBaseModule.prototype.setupStore = function (appState) {
        if (appState === void 0) { appState = Map({}); }
        var /** @type {?} */ store = createReduxStore(/** @type {?} */ (this.rootReducer.reducer()), fromJS(appState), this.getMiddleware(), this.getEnhancers());
    ...
    MainBaseModule.prototype.getMiddleware = function () {
        ...
        if (this.environment.additionalMiddleware) {
            defaultMiddleware = tslib_1.__spread(defaultMiddleware, this.environment.additionalMiddleware);
        }
    ...
    MainBaseModule.prototype.getEnhancers = function () {
        ...
        if (this.environment.additionalEnhancers) {
            defaultEnhancers = tslib_1.__spread(defaultEnhancers, this.environment.additionalEnhancers);
        }
        if (!this.environment.production && this.devTools.isEnabled()) {
            defaultEnhancers = tslib_1.__spread(defaultEnhancers, [this.devTools.enhancer()]);
        }
 ...
 * @suppress {checkTypes} checked by tsc
 */
var APP_REDUCERS = new InjectionToken('APP_REDUCERS');
var APP_EPICS = new InjectionToken('APP_EPICS');
var APP_ERROR_FORMATTERS = new InjectionToken('APP_ERROR_FORMATTERS');
var APP_TRANSLATIONS = new InjectionToken('APP_TRANSLATIONS');
var APP_ENVIRONMENT = new InjectionToken('APP_ENVIRONMENT');
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
...
var RestService = /** @class */ (function () {
     ...
     * @param {?} environment
     */
    function RestService(http, environment) {
        this.http = http;
        this.environment = environment;
...
var StableService = /** @class */ (function () {
     ...
     * @param {?} store
     */
    function StableService(http, store) {
        this.http = http;
        this.store = store;
...
var RootEpic = /** @class */ (function () {
    ...
    function RootEpic(epicConfigs) {
        ...
        this.middleware = createEpicMiddleware(combineEpics.apply(void 0, tslib_1.__spread(epics)));
    }
    /**
    ...
    RootEpic.prototype.epic = function () {
        return combineEpics.apply(void 0, tslib_1.__spread(this.epicConfigs));
    };
    /**
 ...
 * @suppress {checkTypes} checked by tsc
 */
var ɵ0$1 = { name: 'router', reducer: routerReducer };
var ɵ1 = dummyEpic;
...
function normalizedEntityReducerFactory(entityName, namespace, customReducers) {
    ...
    return function (state, action) {
        ...
        var /** @type {?} */ defaultReducers = (_a = {},
            _a[actionNames.readOneStart] = function (s, a) {
...
function normalizedCollectionReducerFactory(entityName, namespace, customReducers) {
    ...
    return function (state, action) {
        ...
        var /** @type {?} */ actionNames = generateCrudActionNames(entityName, namespace);
        var /** @type {?} */ defaultReducers = (_a = {},
            _a[actionNames.readStart] = function (s, a) {
                return mergeState(initialState, { loading: true });
            },
 ...
 */
var createSelector = createSelectorCreator(defaultMemoize, is);
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
...
function normalizedEntitySelectorFactory(entityName, entityClass, schema, customSelectors) {
    ...
    var /** @type {?} */ modelSelector = createSelector([idSelector, entitiesSelector], function (id, entities) {
        if (id) {
            var /** @type {?} */ denormalizedData = denormalize(id, schema, entities);
...
function normalizedCollectionSelectorsFactory(entityName, entityClass, schema, customSelectors) {
    ...
    var /** @type {?} */ modelsSelector = createSelector([idsSelector, entitiesSelector], function (ids, entities) {
        var /** @type {?} */ denormalizedData = denormalize(ids, schema, entities);
...
function EmbeddedCollection(recordClass, collectionFactory) {
    if (collectionFactory === void 0) { collectionFactory = List; }
    return function (target, key) {
        var /** @type {?} */ cache = new WeakMap();
        return {
            /**
...
function ExtendedRecord(Base) {
    return /** @class */ (function (_super) {
        ...
        function class_1() {
            ...
            var _this = this;
            var /** @type {?} */ params = fromJS(args.shift());
            _this = _super.apply(this, tslib_1.__spread([params], args)) || this;
            return _this;
        }
        /**
         * @param {?} params
...
function validateDate(c) {
    var /** @type {?} */ value = parse(c.value, 'YYYY-MM-DD', 0);
...
function validateTime(c) {
    var /** @type {?} */ value = parse(c.value, 'HH:mm', 0);
