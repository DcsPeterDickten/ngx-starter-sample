...
import { generateAsyncActionNames, IAction, IAsyncActionNames, RestService } from '@dcs/ngx-utils';
import { fromJS } from 'immutable';

export const fetchActions: IAsyncActionNames = generateAsyncActionNames('BOOKS_FETCH');
export const insertActions: IAsyncActionNames = generateAsyncActionNames('BOOKS_INSERT');

export const deleteActions: IAsyncActionNames = generateAsyncActionNames('BOOKS_DELETE');
